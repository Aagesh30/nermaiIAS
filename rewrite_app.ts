...
const appPath = path.join(__dirname, 'web_portal', 'App.tsx');
...
${innerContent}
                           ...
                           return (
                             <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingRight: 20 }}>
                               <View style={{ flexDirection: "row", gap: 20, alignItems: "flex-start", width: isMobile ? "100%" : "auto" }}>
                                 {/* Column 1: Upcoming */}
                                 <View style={{ gap: 12, width: isMobile ? 320 : 350 }}>
                                 ...
                                 {/* Column 3: Ended */}
                                 <View style={{ gap: 12, width: isMobile ? 320 : 400 }}>
