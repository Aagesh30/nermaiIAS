...
import newAttendanceRouter from '../modules/new-attendance/routes';
...
router.use('/new-attendance', newAttendanceRouter);
router.use('/v1/new-attendance', newAttendanceRouter);
