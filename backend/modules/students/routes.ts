...
studentRoutes.get('/me/lms-classes', requireAuth, requireRole(['student', 'guest']), StudentController.getMyLmsClassesHandler);
studentRoutes.get('/me/lms-resources', requireAuth, requireRole(['student', 'guest']), StudentController.getMyLmsResourcesHandler);
